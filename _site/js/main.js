/*! skinny-bones-jekyll - v0.0.1 - 2014-08-27 */ ! function($) {
    "use strict";
...
function($) {
    $.fn.smoothScroller = function(options) {
        ...
        return $(options.scrollEl).animate({
            ...
            var hash = el.attr("id");
            hash.length && (history.pushState ? history.pushState(null, null, "#" + hash) : document.location.hash = hash), el.trigger("smoothScrollerComplete")
        }), this
...
function($) {
    ...
    $.fn.toc = function(options) {
        var timeout, self = this,
            ...
            scrollTo = function(e, callback) {
                ...
                $("li", self).removeClass(activeClassName), $(e.target).parent().addClass(activeClassName)
            },
            highlightOnScroll = function() {
                timeout && clearTimeout(timeout), timeout = setTimeout(function() {
                    ...
                    $("li", self).removeClass(activeClassName), highlighted = $("li:eq(" + index + ")", self).addClass(activeClassName), opts.onHighlight(highlighted)
                }, 50)
            };
        return opts.highlightOnScroll && ($(window).bind("scroll", highlightOnScroll), highlightOnScroll()), this.each(function() {
            ...
            headings.each(function(i, heading) {
                ...
                var a = $("<a/>").text(opts.headerText(i, heading, $h)).attr("href", "#" + anchorName).bind("click", function(e) {
                        $(window).unbind("scroll", highlightOnScroll), scrollTo(e, function() {
        ...
        anchorName: function(i, heading, prefix) {
            ...
            return verboseIdCache[candidateId] = !0, prefix + "-" + candidateId
        },
    ...
    $(".js-menu-trigger").on("click touchstart", function(e) {
        $("body").toggleClass("no-scroll"), $(".js-menu, .js-menu-screen").toggleClass("is-visible"), $(".sliding-menu-button").toggleClass("slide close"), $("#masthead, #page-wrapper").toggleClass("slide"), e.preventDefault()
